...
public class IntegrationTests : IDisposable
{
    ...
    public IntegrationTests(DatabaseFixture fixture)
    {
        ...
        _dbContext = new SqlServerDbContext(); // probably needs to be a instance so not a new instance every time
        _dbContextPostgres = new PostgreSqlDbContext(); // probably needs to be a instance so not a new instance every time
